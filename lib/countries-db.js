...
window.CountriesDB = (function () {
  ...
  var countries = [
    ...
    { name: 'Bulgaria', nameDE: 'Bulgarien', iso: 'BG', flag: '\u{1F1E7}\u{1F1EC}', region: 'europe', schengen: false },
    ...
    { name: 'Romania', nameDE: 'Rum\u00E4nien', iso: 'RO', flag: '\u{1F1F7}\u{1F1F4}', region: 'europe', schengen: false },
